...
var _excluded2 = ["skipAnimation", "onItemClick"];
...
var useAggregatedData = () => {
  const seriesData = React12.useContext(SeriesContext).bar ?? {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
...
function ChartsText(props) {
  ...
  const wordsByLines = React18.useMemo(() => getWordsByLines({
    style,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React20.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React21.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
...
function useMouseTracker() {
  const svgRef = React24.useContext(SvgContext);
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React26.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axisValue: import_prop_types12.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types13.default.shape({
    ...
    axisValue: import_prop_types13.default.any,
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React30.useMemo(
  ...
  const padding = React30.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React30.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React30.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React31.useContext(DrawingContext);
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React33.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime29.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime29.jsx)(ChartsAxisHighlightPath, {
...
var _excluded9 = ["vertical", "horizontal"];
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime33.jsxs)(GridRoot, _extends({}, other, {
    ...
    children: [vertical && xTicks.map(({
      formattedValue,
      offset
    }) => (0, import_jsx_runtime32.jsx)("line", {
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      x1: offset,
      x2: offset,
...
var BarChart = React37.forwardRef(function BarChart2(props, ref) {
  ...
  return (0, import_jsx_runtime36.jsxs)(ResponsiveChartContainer, {
    ref,
    ...
    children: [onAxisClick && (0, import_jsx_runtime35.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime35.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime35.jsx)("g", {
      clipPath: `url(#${clipPathId})`,
      children: (0, import_jsx_runtime35.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2,
        onItemClick
      ...
      slots,
      slotProps
    }), (0, import_jsx_runtime35.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime35.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), (0, import_jsx_runtime35.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
//# sourceMappingURL=chunk-OTNUH5NE.js.map
