...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React18.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React18.useEffect(() => {
  ...
  const updateRootElementName = React18.useCallback((instance) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-55CZIUKP.js.map
